...
RUN apt update && \
    apt upgrade && \
    apt -y install openssh-server passwd lsb-release curl libjson-perl libdatetime-format-dateparse-perl libnet-nslookup-perl libdbi-perl libdbd-mysql-perl git && \
